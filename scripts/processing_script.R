...
#=================================================
# STEP 6: EXPORT MASTER DATASETS TO DATA FOLDER
#=================================================

# 1. Write the full cleaned dataset (v2) to the processed folder
# We use write_csv from the tidyverse for better performance with large files
write_csv(all_trips_v2, "data/processed/all_trips_v2_cleaned.csv")

# 2. Save the aggregated counts file there as well
write_csv(counts, "data/processed/avg_ride_length_summary.csv")
